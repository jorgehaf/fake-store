<h1>Sistema simples de e-commerce fake</h1>
...
<h3>Compile e habilite a recarga automática para desenvolvimento, logo a aplicação estará disponível em "[localhost:3000](http://localhost:3000/products/2)"</h3>
$ npm run dev
